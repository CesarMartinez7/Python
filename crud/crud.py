...
class Interfaz(ctk.CTk):
    def __init__(self):
        ...
        self.title("CREATE")
        self.iconbitmap("C:/Users/APRENDIZ SENA/Desktop/REPO/Python/crud/image.ico")
        ...
        self.boton = ctk.CTkButton(self,text="Enviar",width=200,command=self.obtener_Datos)
        ...
        self.eliminarRegistro = ctk.CTkButton(self,text="Elimina registro")
    ...
    def obtener_Datos(self):
        if len(self.emailEntry.get()) >= 5 and len(self.contraseñaEntry.get()) >= 5:
            ...
            self.query(email=self.emailClean,password=self.contraseñaClean)
        else:
    ...
    def query(self,**kwargs):         
        try:
            ...
            f = Figlet(font='slant')
            print(f.renderText('Procesado con exito'))    
